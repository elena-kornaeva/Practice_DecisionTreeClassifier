...
│   ├── raw/              # Исходные данные (не трогать после загрузки!) ← СОЗДАЙТЕ ПАПКУ
│   ├── processed/        # Очищенные, подготовленные данные ← СОЗДАЙТЕ ПАПКУ
...
│   ├── base_model.pkl    # создайте пустой файл
│   ├── rf_model.pkl
│   └── gb_model.pkl
│
── reports/
